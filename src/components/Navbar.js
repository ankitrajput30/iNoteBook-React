...
export const Navbar = () => {
     ...
     return (
          <nav className="navbar navbar-expand-lg navbar-dark" style={{ background: '#1f2123' }}>
               <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                         ...
                         {!localStorage.getItem('token') ? <div className="d-flex">
                              <Link className="btn1 mx-1" to="/login" role="button">Log In</Link>
                              <Link className="btn11 mx-1" to="/signup" role="button">Sign Up</Link>
